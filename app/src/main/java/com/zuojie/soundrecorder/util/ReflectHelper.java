...
public class ReflectHelper {
    private static Map<String, Object> mStoreMap = new HashMap<String, Object>();
    private static Map<String, Class<?>> mClassMap = new HashMap<String, Class<?>>();
    ...
    private static Object invoke(Class<?> objClass, Object obj, String methodName, Object[] params) throws Exception {
        if (params == null || params.length == 0) {
            ...
            Method method = objClass.getMethod(methodName, getParamsTypes(params));
            method.setAccessible(true);
    ...
    public static Object invokeStatic(String className, String methodName, Object[] params) throws Exception {
        Object obj = mStoreMap.get(className + methodName);
        if (obj != null) {
            return obj;
        } else {
            Class<?> objClass = mClassMap.get(mClassMap);
            if (objClass == null) {
                try {
            ...
            obj = invoke(objClass, objClass, methodName, params);
            if (obj != null) {
                mStoreMap.put(className + methodName, obj); // 保存静态方法的返回值
            }
            return obj;
        }
    }
    ...
    private static Object invoke(Class<?> objClass, Object obj, String methodName, Class<?>[] paramsTypes, Object[] params) throws Exception {
        if (params == null || params.length == 0) {
            ...
            Method method = objClass.getMethod(methodName, paramsTypes);
            method.setAccessible(true);
            return method.invoke(obj, params);
        }
    }
    ...
    public static Object getStaticField(String className, String fieldName) throws NoSuchFieldException {
        ...
        Object obj = mStoreMap.get(className + fieldName);
        if (obj != null) {
            return obj;
        } else {
            Class<?> objClass = mClassMap.get(mClassMap);
            ...
            obj = getFieldStepwise(objClass, objClass, fieldName);
            if (obj != null) {
                mStoreMap.put(className + fieldName, obj);
            }
            return obj;
        }
    }
     ...
     * 反射获取指定类的指定方法
     *
     * @author 李广德 2015.12.11
     */
    public static Object getMethod(String className, String methodName, Object[] params) throws Exception {
        ...
        if (obj != null) {
            ...
            if (params == null || params.length == 0) {
                ...
                method.setAccessible(true);
                if (method != null) {
                    mStoreMap.put(className + methodName, method);
                }
                return method;
            } else {
                Method method = objClass.getMethod(methodName, getParamsTypes(params));
